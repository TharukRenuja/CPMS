namespace CPMS
{
    partial class SGuardLogin
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SGuardLogin));
            panel1 = new Panel();
            HomeBtn = new Button();
            InfoTXT = new Label();
            AboutBtn = new Button();
            ...
            // PWDTxt
            // 
            PWDTxt.BorderStyle = BorderStyle.None;
            PWDTxt.Font = new Font("Segoe UI", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            PWDTxt.Location = new Point(935, 376);
            PWDTxt.Name = "PWDTxt";
            PWDTxt.Size = new Size(162, 26);
            PWDTxt.TabIndex = 16;
            ...
            UNameTxt.Font = new Font("Segoe UI", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            UNameTxt.Location = new Point(935, 330);
            UNameTxt.Name = "UNameTxt";
            UNameTxt.Size = new Size(162, 26);
            UNameTxt.TabIndex = 17;
            // 
            // AdminLoginBtn
            // 
            AdminLoginBtn.BackColor = Color.Transparent;
            AdminLoginBtn.BackgroundImage = (Image)resources.GetObject("AdminLoginBtn.BackgroundImage");
            AdminLoginBtn.BackgroundImageLayout = ImageLayout.Stretch;
            AdminLoginBtn.Cursor = Cursors.Hand;
            AdminLoginBtn.FlatAppearance.BorderSize = 0;
            AdminLoginBtn.FlatStyle = FlatStyle.Flat;
            AdminLoginBtn.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            AdminLoginBtn.ForeColor = Color.White;
            AdminLoginBtn.Location = new Point(849, 465);
            AdminLoginBtn.Name = "AdminLoginBtn";
            AdminLoginBtn.Size = new Size(231, 53);
            AdminLoginBtn.TabIndex = 15;
            ...
            label3.Location = new Point(933, 248);
            label3.Name = "label3";
            ...
            label2.Location = new Point(818, 377);
            label2.Name = "label2";
            ...
            label1.Location = new Point(818, 331);
            label1.Name = "label1";
            ...
            pictureBox2.Location = new Point(437, 198);
            ...
            Title.Location = new Point(537, 110);
            Title.Name = "Title";
            Title.Size = new Size(524, 40);
            Title.TabIndex = 18;
            Title.Text = "Trying to Login as a Security Guard...";
            // 
            // B2LogBtn
            // 
            B2LogBtn.BackColor = Color.Transparent;
            B2LogBtn.BackgroundImage = (Image)resources.GetObject("B2LogBtn.BackgroundImage");
            B2LogBtn.BackgroundImageLayout = ImageLayout.Stretch;
            B2LogBtn.Cursor = Cursors.Hand;
            B2LogBtn.FlatAppearance.BorderSize = 0;
            B2LogBtn.FlatStyle = FlatStyle.Flat;
            B2LogBtn.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            B2LogBtn.Location = new Point(347, 22);
            B2LogBtn.Name = "B2LogBtn";
            B2LogBtn.Size = new Size(90, 30);
            B2LogBtn.TabIndex = 19;
            B2LogBtn.Text = "Back   ";
            B2LogBtn.TextAlign = ContentAlignment.MiddleRight;
            ...
            Text = "Security Guard Login | CPMS";
            Load += SGuardLogin_Load;
